...
namespace CouponManagementServiceV2.Core.Filters
{
    public class ApiKeyAuthentication
    {
        ...
        {
            if (!context.Request.GetDisplayUrl().Contains("metrics") && context.Request.Method != "OPTIONS")
            {
    ...
    public class TokenAuthentication
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            if (!context.Request.GetDisplayUrl().Contains("Auth") && !context.Request.GetDisplayUrl().Contains("metrics") && context.Request.Method != "OPTIONS")
            {
